...
<body>
                    ...
                    <div class="card card-content">
                        ...
                        <div class="row book-list">
                            ...
                            <div class="col-md-3 mb-2">
                                <div class="card card-list" data-category="<?= $bookCategory ?>" data-status="<?= $readStatus ?>" data-author="<?= htmlspecialchars($bookAuthor) ?>">
                                <div class="btn-view">
                                ...
                                <div class="card-footer text-center">
                                    <?php for ($i = 1; $i <= 5; $i++): ?>
                                        <i class="fas fa-star" style="color: <?php echo $i <= $rating ? 'gold' : 'gray'; ?>;"></i>
                                    <?php endfor; ?>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function view_details(id) {
            ...
            let ratingHtml = '';
            for (let i = 1; i <= 5; i++) {
                ratingHtml += '<i class="fas fa-star" style="color: ' + (i <= bookRating ? 'gold' : 'gray') + ';"></i>';
            }
