...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <span class="navbar-text ml-3 text-light font-weight-bold">
            <i class="fas fa-search mr-2"></i>Mystery
        </span>
                    ...
                    <div class="card card-content">
                        ...
                        <div class="row book-list">
                            ...
                            <?php
                                ...
                                $stmt = $conn->prepare("SELECT * FROM `tbl_book` WHERE `book_category` = 'Mystery' ORDER BY `tbl_book_id` DESC");
                                $stmt->execute();
                            ...
                            <div class="card card-list mb-2" style="width:17rem;" data-category="<?= $bookCategory ?>" data-status="<?= $readStatus ?>" data-author="<?= htmlspecialchars($bookAuthor) ?>">
                                ...
                                <p id="bookText-<?= $bookID ?>" hidden><?php echo $bookText ?></p>
                                ...
                                <div class="card-footer text-center">
                                    <?php for ($i = 1; $i <= 5; $i++): ?>
                                        <i class="fas fa-star" style="color: <?php echo $i <= $rating ? 'gold' : '#ddd'; ?>;"></i>
                                    <?php endfor; ?>
                                </div>
                                <?php endif; ?>
                            </div>
