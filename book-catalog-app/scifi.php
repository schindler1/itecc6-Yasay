                    ...
                    <div class="card card-content">
                        ...
                        <div class="row book-list">
                            ...
                            <?php
                                ...
                                $stmt = $conn->prepare("SELECT * FROM `tbl_book` WHERE `book_category` = 'Science Fiction' ORDER BY `tbl_book_id` DESC");
                                $stmt->execute();
                            ...
                            <div class="card card-list mb-2" style="width:17rem;" data-category="<?= $bookCategory ?>">
                                <div class="btn-view">
